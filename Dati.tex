...
% Dati dello Studente
\newcommand{\nomeStudente}{Davide}
\newcommand{\cognomeStudente}{Biasuzzi}
\newcommand{\matricolaStudente}{2111000}
\newcommand{\emailStudente}{biasuzzi.davide@studenti.unipd.it}
\newcommand{\telStudente}{+39 371 158 7339}

% Dati del Tutor Aziendale
\newcommand{\nomeTutorAziendale}{Michele}
\newcommand{\cognomeTutorAziendale}{Francheschet}
\newcommand{\emailTutorAziendale}{michele.franceschet@centurio.io}
\newcommand{\telTutorAziendale}{+ 39 333 288 9982}
\newcommand{\ruoloTutorAziendale}{}

% Dati dell'Azienda
\newcommand{\ragioneSocAzienda}{Centurio SRL}
\newcommand{\indirizzoAzienda}{Vicolo G. Amendola, 23
31025 Santa Lucia di Piave (TV)}
\newcommand{\sitoAzienda}{https://centurio.io/}
\newcommand{\emailAzienda}{info@centurio.io}
\newcommand{\partitaIVAAzienda}{P.IVA 05512310268}
